    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 pt-16 text-center">
        <h1
          ...
          className="about-hero-title mb-6 font-heading text-4xl font-bold uppercase tracking-tight md:text-6xl lg:text-7xl"
        >
          About Us
        </h1>

        <p className="about-hero-subtitle mx-auto max-w-2xl text-lg text-muted-foreground md:text-xl">
