        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="page-subtitle">
              Created {format(new Date(b.created_at), "MMMM d, yyyy")} at{" "}
              {format(new Date(b.created_at), "h:mm a")}
            </p>
          </div>
        </div>
              ...
              {b.price_deposit != null && (
                <div className="flex justify-between text-sm">
                  ...
                  <span style={{ color: "var(--text-muted)" }}>
                    ${b.price_deposit.toLocaleString()}
                  </span>
                </div>
              )}
              {b.payment_status && (
                  ...
                  >
                    <p style={{ color: "var(--text-faint)" }}>
                      ...
                      <span style={{ color: "#DC3545" }}>
                        {format(new Date(record.from_date), "MMM d, yyyy")}
                      </span>
                    </p>
                    <p style={{ color: "var(--text-faint)" }}>
                      To:{" "}
                      <span style={{ color: "#28A745" }}>
                        {format(new Date(record.to_date), "MMM d, yyyy")}
                      </span>
                    </p>
                    {record.reason && (
                      <p
