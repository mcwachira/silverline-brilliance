...
export default function LoginForm() {
  ...
  return (
    <main
      ...
      style={{
        background:
          "radial-gradient(ellipse 80% 80% at 50% -20%, rgba(139,31,168,0.35) 0%, rgba(15,15,19,1) 60%)",
      }}
    >
      {/* Decorative orbs */}
      <div
      ...
      />
      <div
        className="absolute bottom-1/4 -right-32 w-64 h-64 rounded-full opacity-15 blur-3xl"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          >
            <Lock
              className="w-6 h-6 text-gold-gradient"
