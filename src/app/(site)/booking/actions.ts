...
import {adminSupabase} from "@/src/lib/supabase/server";
...
export async function submitBooking(rawData:unknown):Promise<BookingActionResult>{
  ...
  // await sendBookingConfirmation({ to: data.email, bookingReference, eventName: data.eventName })
